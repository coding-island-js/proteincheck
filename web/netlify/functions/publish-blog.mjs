...
- ATTRIBUTE key guidelines to the TYPE of authority behind them, in plain prose (e.g. "U.S. dietary guidance puts the baseline around...", "sports-nutrition guidelines suggest...", "the USDA's food database lists..."). This makes the answer more quotable and trustworthy. But NEVER fabricate a specific study title, author name, journal, year, percentage, or URL — only name the general kind of source.
